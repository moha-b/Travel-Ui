...
class DestinationHotelScreen extends StatefulWidget {
  Hotel dest;

  DestinationHotelScreen({
    Key? key,
    required this.dest,
  }) : super(key: key);

  @override
  State<DestinationHotelScreen> createState() => _DestinationHotelScreenState();
}

class _DestinationHotelScreenState extends State<DestinationHotelScreen> {
